...
scenarioEvidencePlan:
  - AC-P5-REL-001|E5|Release candidate full P0 through P4 MUST journey audit with fault injection and contract drift check
crossCuttingPlan:
...
allowedPaths:
  - deploy/compose/scripts/p5-completion-audit
  - docs/ai-spec/02-delivery/traceability-matrix.md
  - docs/ai-spec/tasks/evidence/EVD-P5007-001.yaml
...
requiredValidationCommands:
  ...
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P5-007.md
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P5-007.md -CheckChangedPaths
...
---
# TASK-P5-007：P0-P5 发布候选全量审计

> 状态：`READY`

## 1. 目标

完成 REQ-REL-001 发布候选 Commit 全量 P0-B 至 P4 MUST Journey 恢复与一致性审计。

## 2. 关联规格

```yaml
requirements: ['REQ-REL-001']
acceptanceScenarios: ['AC-P5-REL-001']
decisions: ['DEC-010']
```
...
| --- | --- | --- | --- | --- | --- |
| `AC-P5-REL-001` | Operator | Release candidate full P0 through P4 MUST journey audit with fault injection and contract drift check | Execute | PASS | `E5` |
...
- [ ] p5-completion-audit 脚本；追踪矩阵缺口检查；Evidence Manifest 绑定同一 Commit。
- [ ] 编写/更新测试覆盖全部 AC
