...
scenarioEvidencePlan:
  - AC-P5-OPS-001|E5|Dashboard alert runbook fault drill for service dead job consistency backup webhook failures
crossCuttingPlan:
...
allowedPaths:
  ...
  - docs/runbooks
  - docs/ai-spec/tasks/evidence/EVD-P5006-001.yaml
...
requiredValidationCommands:
  ...
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P5-006.md
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P5-006.md -CheckChangedPaths
...
---
# TASK-P5-006：Dashboard 告警与运维 Runbook

> 状态：`READY`

## 1. 目标

实现 REQ-OPS-001 运行 Dashboard、告警规则与 Runbook，经故障演练验证。

## 2. 关联规格

```yaml
requirements: ['REQ-OPS-001']
acceptanceScenarios: ['AC-P5-OPS-001']
decisions: ['DEC-010']
```
...
| --- | --- | --- | --- | --- | --- |
| `AC-P5-OPS-001` | Operator | Dashboard alert runbook fault drill for service dead job consistency backup webhook failures | Execute | PASS | `E5` |
...
- [ ] Dashboard SLI 面板；Alert 规则与 dedupe；Runbook 演练记录。
- [ ] 编写/更新测试覆盖全部 AC
