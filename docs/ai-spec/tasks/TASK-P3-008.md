...
scenarioEvidencePlan:
  - AC-P3-EXIT-001|E4|Compose validate→publish→deprecate journey with triplet integrity
crossCuttingPlan:
...
allowedPaths:
  ...
  - deploy/compose/fixtures
  - docs/ai-spec/tasks/evidence/EVD-P3008-001.yaml
...
requiredValidationCommands:
  ...
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P3-008.md
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P3-008.md -CheckChangedPaths
...
---
# TASK-P3-008：发布不可变完整 Compose 出口

> 状态：`READY`

## 1. 目标

Compose 环境完成 P3 纵向出口：validate→publish→deprecate 全链 PASS。

## 2. 关联规格

```yaml
requirements: ['REQ-PUB-001', 'REQ-IMM-001']
acceptanceScenarios: ['AC-P3-EXIT-001']
...
| --- | --- | --- | --- | --- | --- |
| `AC-P3-EXIT-001` | Actor | Given preconditions | Execute action | PASS criteria | `E4` |
