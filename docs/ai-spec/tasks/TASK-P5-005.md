...
scenarioEvidencePlan:
  - AC-P5-SEC-001|E5|Security validation suite SAST dependency image secret and injection tests
crossCuttingPlan:
...
allowedPaths:
  ...
  - docs/ai-spec/tasks/evidence/EVD-P5005-001.yaml
...
requiredValidationCommands:
  ...
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P5-005.md
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P5-005.md -CheckChangedPaths
  - test -d deploy/security
approvedBy: User (plan execution authorization 2026-07-10)
approvedAt: 2026-07-10T00:00:00Z
---
# TASK-P5-005：安全验证与内容供应链扫描

> 状态：`READY`

## 1. 目标

实现 REQ-SEC-001 安全验证与内容供应链扫描门禁。

## 2. 关联规格

```yaml
requirements: ['REQ-SEC-001']
acceptanceScenarios: ['AC-P5-SEC-001']
decisions: ['DEC-010']
```
...
| --- | --- | --- | --- | --- | --- |
| `AC-P5-SEC-001` | Operator | Security validation suite SAST dependency image secret and injection tests | Execute | PASS | `E5` |
...
- [ ] SAST/依赖/镜像/Secret 扫描；越权/注入/SSRF 测试；漏洞阈值门禁。
- [ ] 编写/更新测试覆盖全部 AC
