...
scenarioEvidencePlan:
  - AC-P5-BKR-001|E5|Backup restore drill meeting RPO RTO with random Published DVC verification
crossCuttingPlan:
...
allowedPaths:
  - deploy/backup
  - deploy/compose/scripts/p5-restore
  - docs/runbooks/backup-restore.md
  - docs/ai-spec/tasks/evidence/EVD-P5003-001.yaml
...
requiredValidationCommands:
  ...
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P5-003.md
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P5-003.md -CheckChangedPaths
...
---
# TASK-P5-003：PostgreSQL/Gitea/MinIO/Secret 备份恢复演练

> 状态：`READY`

## 1. 目标

实现 REQ-BKR-001 备份、恢复与隔离演练，达 RPO/RTO 并校验随机 Published Version。

## 2. 关联规格

```yaml
requirements: ['REQ-BKR-001']
acceptanceScenarios: ['AC-P5-BKR-001']
decisions: ['DEC-010']
```
...
| --- | --- | --- | --- | --- | --- |
| `AC-P5-BKR-001` | Operator | Backup restore drill meeting RPO RTO with random Published DVC verification | Execute | PASS | `E5` |
...
- [ ] 备份脚本与加密；隔离恢复流程；DVC/Manifest 校验；Reconciler 无差异验证。
- [ ] 编写/更新测试覆盖全部 AC
