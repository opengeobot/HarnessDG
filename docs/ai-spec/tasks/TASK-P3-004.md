...
scenarioEvidencePlan:
  - AC-P3-PUB-001|E4|PublishJobHandler creates Gitea tag when enabled and persists PUBLISHED triplet
crossCuttingPlan:
...
allowedPaths:
  ...
  - docs/ai-spec/tasks/evidence/EVD-P3004-001.yaml
...
requiredValidationCommands:
  ...
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P3-004.md
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P3-004.md -CheckChangedPaths
...
---
# TASK-P3-004：publish Saga 创建受保护 Gitea Tag 并形成三元组

> 状态：`READY`

## 1. 目标

VERSION_PUBLISH Saga 在 Gitea 启用时创建受保护 Tag 并完成 PG 三元组。

## 2. 关联规格

```yaml
requirements: ['REQ-PUB-001']
acceptanceScenarios: ['AC-P3-PUB-001']
...
| --- | --- | --- | --- | --- | --- |
| `AC-P3-PUB-001` | Actor | Given preconditions | Execute action | PASS criteria | `E4` |
