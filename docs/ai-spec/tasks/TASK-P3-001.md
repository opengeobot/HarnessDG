...
scenarioEvidencePlan:
  - AC-P3-REV-001|E3|State machines, permissions and error catalog aligned with publish governance
crossCuttingPlan:
...
allowedPaths:
  ...
  - docs/ai-spec/tasks/evidence/EVD-P3001-001.yaml
...
requiredValidationCommands:
  ...
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P3-001.md
  - pwsh ./docs/ai-spec/tools/validate-task-card.ps1 -TaskPath docs/ai-spec/tasks/TASK-P3-001.md -CheckChangedPaths
...
---
# TASK-P3-001：审批角色、策略、版本规则与状态机 READY

> 状态：`READY`

## 1. 目标

将审批角色、策略、版本状态机与错误目录固化为 P3 可实施基线。

## 2. 关联规格

```yaml
requirements: ['REQ-REV-001', 'REQ-IMM-001']
acceptanceScenarios: ['AC-P3-REV-001']
...
| --- | --- | --- | --- | --- | --- |
| `AC-P3-REV-001` | Actor | Given preconditions | Execute action | PASS criteria | `E3` |
