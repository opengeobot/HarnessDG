...
**不得将 PARTIAL / IMPLEMENTED_UNVERIFIED 表述为阶段 VERIFIED。** 全部 P1–P5 Evidence Manifest 仍为 `DRAFT`，需 W7 翻转。
...
| 全量 `./mvnw verify` / Compose `verify.sh` 行为级 P1–P5 | 未作为本快照出口证据；Compose 默认曾未设 `AIHUB_GITEA_ENABLED=true` |
